...
function bucket() {
    ...
    div.innerHTML="<h2>Bucket "+
                    localcounter+"</h2><ul class='highlight w3-ul w3-border w3-hoverable w3-card-2' id=qux"+counter+"><li></li></ul><span onclick='this.parentElement.style.display=\x22none\x22' class='w3-button'>&times;</span>";
    var x = 'qux'+ counter;
    counter++;
